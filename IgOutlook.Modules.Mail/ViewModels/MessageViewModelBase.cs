...
namespace IgOutlook.Modules.Mail.ViewModels
{
    public class MessageViewModelBase : NavigationAwareViewModelBase
    {
        ...
        public string CurrentMailbox
        {
            ...
            set { SetProperty(ref _currentMailbox, value); }
        }
        ...
        private ObservableCollection<Contact> _mailParticipants;
        public ObservableCollection<Contact> MailParticipants
        {
            get { return _mailParticipants; }
            set { SetProperty(ref _mailParticipants, value); }
        }
