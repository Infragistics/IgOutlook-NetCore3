...
namespace IgOutlook.Core.Behaviors
{
    public class EventToCommand : TriggerAction<UIElement>
    {
        ...
        public static readonly DependencyProperty AutoEnableProperty =
            DependencyProperty.Register("AutoEnable", typeof(bool), typeof(EventToCommand),
                new PropertyMetadata(true, (d, e) => ((EventToCommand)d).OnAllowDisableChanged((bool)e.NewValue)));
        ...
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register("Command", typeof(ICommand), typeof(EventToCommand),
                new PropertyMetadata(null, (d, e) => ((EventToCommand)d).OnCommandChanged((ICommand)e.NewValue)));
        ...
        public static readonly DependencyProperty CommandParameterProperty =
            DependencyProperty.Register("CommandParameter", typeof(object), typeof(EventToCommand),
                new PropertyMetadata(null, (d, e) => ((EventToCommand)d).OnCommandParameterChanged(e.NewValue)));
        ...
        public static readonly DependencyProperty EventArgsConverterProperty = DependencyProperty.Register("EventArgsConverter", typeof(IValueConverter), typeof(EventToCommand), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty TriggerParameterPathProperty =
            DependencyProperty.Register("TriggerParameterPath", typeof(string), typeof(EventToCommand),
        ...
        /// It is not possible to make the <see cref="EventToCommand"/> inherit from <see cref="CommandBehaviorBase{T}"/>, since the <see cref="EventToCommand"/>
