...
{
    public class XamDataTreeProperties
    {
        #region SelectedDataItem

        public static readonly DependencyProperty SelectedDataItemProperty = DependencyProperty.RegisterAttached("SelectedDataItem", typeof(object), typeof(XamDataTreeProperties), new PropertyMetadata(null, OnSelectedDataItemChanged));
        ...
        public static readonly DependencyProperty UnselectedDataItemProperty = DependencyProperty.RegisterAttached("UnselectedDataItem", typeof(object), typeof(XamDataTreeProperties), new PropertyMetadata(null, null, CoerceUnselectedDataItem));
        ...
        public static readonly DependencyProperty DefaultSelectedDataItemProperty = DependencyProperty.RegisterAttached("DefaultSelectedDataItem", typeof(object), typeof(XamDataTreeProperties), new PropertyMetadata(null, OnDefaultSelectedDataItemChanged));
