...
{
    /// <summary>
    /// Interaction logic for FormatTextTab.xaml
    /// </summary>
    public partial class FormatTextTab : ISupportDataContext, ISupportRichText
    {
        #region Members
        ...
        public static readonly DependencyProperty RichTextEditorProperty = DependencyProperty.Register("RichTextEditor", typeof(XamRichTextEditor), typeof(FormatTextTab), new PropertyMetadata(null, OnRichTextEditorChanged));
        ...
        {
            FormatTextTab tab = d as FormatTextTab;
            if (tab != null)
        ...
        private void FontFamily_SelectionChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
        {
            ...
            {
                //TODO: Provide info for incorrect font name
            }
        }
