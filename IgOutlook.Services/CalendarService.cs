...
namespace IgOutlook.Services
{
    public class CalendarService : ICalendarService
    {
        ...
        {
            return new ObservableCollection<ResourceCalendar>(_resourceCalendars.Where(rc => rc.OwningResourceId.Contains("conferenceRoom")));
        }

        public ObservableCollection<ResourceCalendar> GetUserResourceCalendars(string userId)
        {
            return new ObservableCollection<ResourceCalendar>(_resourceCalendars.Where(rc => rc.OwningResourceId == userId));
        }

        public ObservableCollection<ResourceCalendar> GetTeamResourceCalendars(string userId)
        {
            return new ObservableCollection<ResourceCalendar>(_resourceCalendars.Where(rc => rc.OwningResourceId != userId && !rc.OwningResourceId.StartsWith("conferenceRoom")));
        }
        ...
        static bool _wasDataInitilized = false;

        public CalendarService()
        {
            if (!_wasDataInitilized)
            {
                InitializeData();
                _wasDataInitilized = true;
            }
        }

        #region Data

        private static ObservableCollection<Resource> _resources = new ObservableCollection<Resource>();
        private static ObservableCollection<ResourceCalendar> _resourceCalendars = new ObservableCollection<ResourceCalendar>();
        ...
        private void InitializeData()
        {
            ...
            _resources.Add(davids);
            _resources.Add(bobbyj);
            _resources.Add(jonathanb);
            _resources.Add(barbarab);
            _resources.Add(maryh);
            _resources.Add(conferenceRoomA);
            _resources.Add(conferenceRoomB);
            ...
            _resourceCalendars.Add(davidsCalendar);
            _resourceCalendars.Add(bobbyjCalendar);
            _resourceCalendars.Add(jonathanbCalendar);
            _resourceCalendars.Add(barbarabCalendar);
            _resourceCalendars.Add(maryhCalendar);
            _resourceCalendars.Add(conferenceRoomCalendar1);
            _resourceCalendars.Add(conferenceRoomCalendar2);
            ...
            davidsProductIncrementReview.Description = ServiceResources.ProductIncrementReviewDescription;
            ...
            _appointments.Add(davidsProductIncrementReview);
            ...
            _appointments.Add(davidsLuchWithSara);
            ...
            _appointments.Add(davidsCallJohn);
        ...
        public void GenerateAssociatedAppointments(Appointment appointment)
        {
            ...
            var organizer = _resources.FirstOrDefault(r => r.Id == appointment.OwningResourceId);
            ...
            {
                var resource = _resources.FirstOrDefault(r => r.EmailAddress == email);

                if (resource == null) continue;

                var calendar = _resourceCalendars.FirstOrDefault(c => c.OwningResourceId == resource.Id);
